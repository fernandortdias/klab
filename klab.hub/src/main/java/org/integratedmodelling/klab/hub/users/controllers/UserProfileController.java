...
public class UserProfileController {
	...
	public ResponseEntity<?> getCurrentUserProfile(@PathVariable String id, @PathVariable String opid) {
		ProfileResource profile = userService.getCurrentUserProfile(Boolean.valueOf(opid));
		return new ResponseEntity<>(profile,HttpStatus.ACCEPTED);
	}
