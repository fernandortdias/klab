package org.integratedmodelling.klab.hub.security.keycloak;
...
public class KeycloakSecurityService {
    ...
    public boolean isUser(String userName, String opid) {
        if (Boolean.valueOf(opid)) {
            ...
            if (securityUsername != null) {
                return securityUsername.equals(userName);
            }
        }
